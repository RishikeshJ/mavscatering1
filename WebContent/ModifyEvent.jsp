...
<tr>
   <td>
    <form name="Modifyevent" action="<c:url value='/eventController?action=ModifyEventDetails' />" method="post">
  ...
  <%-- 	<tr>
	...
	<td> <input name="staff_lname" value="<c:out value='${EVENT.staff_lname}'/>" type="text">  </td>
  	</tr>
	<tr>
	<td> Assigned Staff First Name: </td>
	<td> <input name="staff_fname" value="<c:out value='${EVENT.staff_fname}'/>" type="text">  </td>
  	</tr>
